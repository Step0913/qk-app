...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildQuickActions(ThemeData theme) {
    final actions = [
      {'icon': Icons.fitness_center, 'label': '添加运动', 'route': AppRoutes.exerciseAdd},
      {'icon': Icons.restaurant_menu, 'label': '添加饮食', 'route': AppRoutes.dietAdd},
      {'icon': Icons.check_circle_outline, 'label': '习惯打卡', 'route': AppRoutes.habit},
      {'icon': Icons.menu_book, 'label': '健康科普', 'route': AppRoutes.knowledgeList},
    ];
