  ...
  Route<dynamic>? _onGenerateRoute(RouteSettings settings) {
    ...
    final routes = <String, WidgetBuilder>{
      ...
      AppRoutes.knowledgeList: (_) =>
          const KnowledgePlaceholder(title: '健康科普'),
      ...
      AppRoutes.profileNickname: (_) =>
          const ProfilePlaceholder(title: '昵称设置'),
      AppRoutes.profileGoal: (_) =>
          const ProfilePlaceholder(title: '健康目标'),
      AppRoutes.profileSettings: (_) =>
          const ProfilePlaceholder(title: '设置'),
    };
